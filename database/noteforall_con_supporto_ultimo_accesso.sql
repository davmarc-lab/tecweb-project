...
--
-- Host: 127.0.0.1:3307
-- Creato il: Gen 15, 2024 alle 22:49
...
(25, 'tower.png', 'uploads/tower.png', NULL),
(26, 'jose-golzman-circusrender.jpg', 'uploads/jose-golzman-circusrender.jpg', NULL),
(27, 'jose-golzman-circusrender.jpg', 'uploads/jose-golzman-circusrender.jpg', NULL),
(28, 'jose-golzman-space.jpg', 'uploads/jose-golzman-space.jpg', NULL),
(29, 'jose-golzman-circusrender.jpg', 'uploads/jose-golzman-circusrender.jpg', NULL),
(30, 'immagine_profilo (2).jpg', 'uploads/immagine_profilo (2).jpg', NULL),
(31, 'jose-golzman-circusrender.jpg', 'uploads/jose-golzman-circusrender.jpg', NULL),
(32, 'immagine_profilo (3).jpgciaooooojddnndd', 'uploads/immagine_profilo (3).jpgciaooooojddnndd', NULL),
(33, 'WashingTask.png20240115175714', 'uploads/WashingTask.png20240115175714', NULL),
(34, '20240115180006ExitTask.png', 'uploads/20240115180006ExitTask.png', NULL);
...
(62, 'Follower', 'marros started following you', 0, 7, 53),
(64, 'Follower', 'marros started following you', 0, 9, 55),
(69, 'Follower', 'marros started following you', 0, 2, 60),
(72, 'Follower', 'marros started following you', 0, 6, 63),
(75, 'Follower', 'penazziricc started following you', 1, 3, 66),
(76, 'Like', 'penazziricc liked your photo', 1, 3, 38),
(81, 'Follower', 'admin started following you', 1, 3, 70),
(82, 'Comment', 'admin added a comment to your post', 1, 3, 0),
(87, 'Comment', 'marros added a comment to your post', 1, 43, 0),
(88, 'Comment', 'marros added a comment to your post', 1, 43, 0),
(91, 'Follower', 'marros started following you', 1, 43, 75),
(92, 'Like', 'marros liked your photo', 1, 43, 44),
(93, 'Comment', 'marros added a comment to your post', 1, 43, 0),
(94, 'Comment', 'marros added a comment to your post', 1, 43, 0),
(95, 'Comment', 'marros added a comment to your post', 1, 43, 0),
(96, 'Follower', 'penazziricc started following you', 0, 30, 76),
(97, 'Follower', 'penazziricc started following you', 0, 7, 77);
...
(157, 'Psicologia Clinica', 'Approfondimenti sulla psicologia clinica contemporanea', 0, 1, 3, 16, 14, NULL, '2024-01-01 17:12:20'),
...
(206, 'Teoria dei Giochi', 'Approfondimenti sulla teoria dei giochi con il prof. Martini', 1, 0, 2, 13, 16, NULL, '2023-12-23 08:55:09'),
...
(232, 'Scienze della Terra Applicata', 'Applicazioni pratiche delle scienze della terra con il prof. Volterra', 1, 0, 4, 16, 15, NULL, '2024-01-02 18:55:09'),
...
(243, 'Teatro Classico', 'Esplorazione del teatro classico con il prof. Shakespeare', 1, 1, 3, 13, 13, NULL, '2024-01-02 18:55:09'),
...
(247, 'Appunti tecweb 2024', 'Appunti del corso tecnologie web con la prof Mirri anno accademico 2024', 1, 5, 43, 30, 31, NULL, NULL);
...
(44, 'ciao', 157, 2),
(45, 'prova\r\n', 243, 2),
(46, 'Wow molto bella la copertina!', 247, 3),
(47, 'Anche gli appunti sono veramente ottimi, grazie mille!', 247, 3),
(48, 'Wow proviamo ste email!!', 247, 3),
(49, 'MMh speriamo la mail non arrivi se no è un problema', 247, 3),
(50, 'Ok ora invece dovrebbe arrivare', 247, 3);
...
INSERT INTO `utente` (`IdUser`, `Name`, `Surname`, `NumberFollower`, `NumberPost`, `lastseen`, `Username`, `Email`, `Password`, `Description`, `IdMedia`) VALUES
(2, 'admin', 'super', 1, 0, NULL, 'admin', 'admin@nfa.com', '$2y$10$pX.RsB/uooJRrd0KID2BRezUAeZZzRiGMnjPbHfp6ZZ306enNcxJy', 'i\'m the captain now', 19),
(3, 'Mario', 'Rossi', 2, 0, '2024-01-15 22:34:47', 'marros', 'mario.rossi@gmail.com', '$2y$10$m332ogYh5M9IFR4UYkdCIOhp1F1IetMLhjJGB3TYsUwoisgNEqfIi', NULL, 19),
(4, 'Riccardo', 'Penazzi', 2, 0, '2024-01-15 22:37:18', 'riki17', 'rp@note.com', '$2y$10$3w5jlZ/8Q2kHYcsfg/co6uhIV5Oi2v9BYJBU7re3/OO07y.RKtcyu', NULL, 19),
(6, 'Davide', 'Marchetti', 1, 0, NULL, 'davmarc', 'davide.marchetti6@studio.unibo.it', '$2y$10$5AhtSA..GFsbdymHMDvAOu6.akHphl62/4g4yva.Kg1KIaGxkd9qO', NULL, 19),
(7, 'Filippo', 'Pracucci', 2, 0, NULL, 'filprac', 'filippo.pracucci@studio.unibo.it', '$2y$10$8gv5SAgVq0dBH9lUM9Fy9udWWpUMIjXlgBPpjMBQx0sy7FjU3.wLq', NULL, 19),
(8, 'Luigi', 'Bianchi', 0, 0, NULL, 'luibia', 'luigi.bianchi@nfa.com', '$2y$10$4xUD3Mog7NStE.Z94sfSdOpSe.PEKZMuvArFw7gxc1hb7qSzPuFMm', NULL, 19),
(9, 'Lisa', 'Simpson', 2, 0, NULL, 'lisasimp', 'lisa.simpson@springfield.com', '$2y$10$9wuiYeOHnKkNN7dpb32Aa.F6FZsap7BGi65z50BD1G33bw187j5Zi', NULL, 19),
(10, 'Bart', 'Simposon', 1, 0, NULL, 'bartsimp', 'bart.simpson@springfield.com', '$2y$10$4un/oGXOIOXRqBjzNFdVoOz72x4KDL47iHldAhcGM89cdk1EEzlUi', NULL, 19),
(11, 'Federica', 'Neri', 0, 0, NULL, 'fedeneri', 'fedeneri@email.com', '$2y$10$4nNzcZRJqgoruVNp8ypB4O2hz.s4LyWLnT.VRa6aLpl7BOmf7HKpK', NULL, 19),
(12, 'Ludovica', 'Pellegrini', 0, 0, NULL, 'ludopelle', 'ludopelle@email.com', '$2y$10$aZjdTwGCz1svh56wWRd7ue0Z7DqM5ZVgnVYYlAVODeIWfLMoDH1wC', NULL, 19),
(13, 'Giacomo', 'Verdi', 0, 0, NULL, 'giaverdi', 'giaverdi@email.com', '$2y$10$EHY59h7MzKcOFgeIIiyb/O9I64X9a9epBhO0rlPYcBnxpKPVienLK', NULL, 19),
(14, 'Gianni', 'Gialli', 0, 0, NULL, 'giangial', 'giannigialli@email.com', '$2y$10$BPojrnHq72Qn8xkn180iyO29V4Kn0MG1m8e0NuqjGbJcxUH7kxeji', NULL, 19),
(15, 'Giulia', 'Violi', 0, 0, NULL, 'giuvioli', 'giuvioli@email.com', '$2y$10$UEHRr6gyyIRndRJrJv9xBuEU9wviFr/.z9ee9O7IBnBqVjw9V86G6', NULL, 19),
(16, 'Elisa', 'Arancioni', 0, 0, NULL, 'eliaranc', 'eliarancioni@email.com', '$2y$10$g0R5b.81DSK1nXFlTHeUvOLh5QK1Z9e0HDM1HSf09RSmSqiousq.a', NULL, 19),
(28, 'a', 'a', 0, 0, NULL, 'ssasssaax', 'csksks@jss', '$2y$10$6ztD/MdiuDRIRj6myw0VXuycM/5fSSOQ1fPo5OZ2m99mp51vt06Ta', NULL, 19),
(29, 'Devis', 'Mari', 0, 0, NULL, 'demar', 'devismari@email.com', '$2y$10$egxwlKMrIyLizIEij780oeqTzvoES6EKmmysezW2LzyddspwMAPla', NULL, 20),
(30, 'Giacomo', 'Spina', 1, 0, NULL, 'giaspina', 'giaspina@email.com', '$2y$10$KmK94gpuvjjrf/.PsZF9ROoJ2c4XuEDnuxmlkAYB0ORTmQMQYy.zi', NULL, 22),
(31, 'Annalisa', 'Libro', 0, 0, NULL, 'annalibro', 'annalibro@email.com', '$2y$10$0xwnr6wXvBmMARoPXbPoiuGNHT5rAnNU/Ow6JHfLSnSCeImAfl5aW', NULL, 22),
(32, 'Giovanni', 'Bianchi', 0, 0, NULL, 'giobia', 'giobia@email.com', '$2y$10$v.xjgQf52Zge8CydcwjrL.Cha.v.iuoPg4BBHfpxjoDaDvouSMpKi', NULL, 23),
(33, 'Alberto', 'Tastiera', 0, 0, NULL, 'albitast', 'albitast@email.com', '$2y$10$.O1OrmWK26T8Ntoe5wz6NumMMf2AmKYAjswlPM1gOL89lRok4VdFe', NULL, 24),
(35, 'Francesca', 'Pianta', 0, 0, NULL, 'frapianta', 'frapianta@email.com', '$2y$10$gHnTztZ85BQphNHF61caoOssyJLiXzjS2ZzJWAqAIgzWq/9D4tIhO', NULL, 19),
(36, 'Ernesto', 'Bottiglia', 0, 0, NULL, 'ernbott', 'ernbott@email.com', '$2y$10$XQ1VzDh/fGqu4KR1w1K0muG9Kb7aUTca4RgB3uKnkAtXZo01xqU5G', NULL, 19),
(37, 'Paio di', 'Occhiali', 0, 0, NULL, 'paioocch', 'paioocch@email.com', '$2y$10$PedSNgxVFc481FWbW7UYvePx7x.bStMQ9yH0bI3tToShOjgEkuIVi', NULL, 19),
(38, 'Luca', 'Toni', 0, 0, NULL, 'lucatoni', 'lucatoni@email.com', '$2y$10$P7wYyCVQTM75zFLgVKX8iuYTSxqozZhcJ3NqUYavNuEpBYc6nPVzK', NULL, 19),
(39, 'd', 'd', 0, 0, NULL, 'd', 'd@ddsnsn', '$2y$10$N//waF5aNTGU0paOKXWbg.uQekzuyZZnR.yDlF7GPTfPFSlneeyZy', NULL, 19),
(40, 'q', 'q', 0, 0, NULL, 'q', 'q@j', '$2y$10$EEtb7TAjspxjz7tgLRbemOliYHBK4nfAVH76VHfsYB.2EkGVRf1.C', NULL, 19),
(41, 'd', 'd', 0, 0, NULL, 'y', 'd@ddkndknsns', '$2y$10$j.dsVGdIFuNM8bf3b50CmOnUQRJwgzfg9NMyID9E0W2ZmESmE1pi6', NULL, 19),
(42, 'Gigi', 'Wp', 0, 0, NULL, 'gwp', 'gwp@email.com', '$2y$10$Grv1Rr373iWE8sNegkh.0.YwN13FwioqSWKgFl55Ig.F6sLcfY7X.', '', 27),
(43, 'Riccardo', 'Penazzi', 1, 0, '2024-01-15 22:29:03', 'penazziricc', 'penazziriccardo17@gmail.com', '$2y$10$21oieQifRUEXi1cDMrFgKOE/z.8V6Upq0YCOMKB/yFk9e6nVMjTvm', NULL, 28),
(46, 'xasasaa', 'adadada', 0, 0, NULL, 'saasasafsadll', 'jdjdjsjnasasdfdassdaasasq@ejen.o', '$2y$10$O8frIizBSpCZUQKDrP/cMO6eoAF5PPtUBWBbYrz2F6QKCZSaXVhLu', NULL, 32),
(47, 'sdxasasas', 'asasaszx', 0, 0, NULL, 'aasadascacdasd', 'asasasaaa@email', '$2y$10$uA3LjIPBL.RHbcPm./RCKOW5tSVQL/Q8VH8.dCW.9a3AIr339VaVa', '', 34);
...
--
ALTER TABLE `media`
  MODIFY `IdMedia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `post`
  MODIFY `IdPost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=248;
...
--
ALTER TABLE `vote`
  MODIFY `IdVote` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

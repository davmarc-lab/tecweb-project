                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mt-1">
                            ...
                            <li class="nav-item p-2 mt-1">
                                <form action="<?php echo $this->homePath . $this->logout; ?>">
                                    <button class="icon-link icon-link-hover link-underline-opacity-0 link-underline-opacity-75-hover logout-button" type="submit">
                            ...
                            <li class="nav-item p-2 mt-1">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" role="switch" id="switch-theme" />

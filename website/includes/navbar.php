...
class Navbar
{
    ...
    private $style = "includes/navbarStyle.css";
            ...
            <div class="navbar-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mt-1">
                    <li class="nav-item p-2 mt-1">
                        <a href="<?php echo (($this->homePath) . ($this->homePage)); ?>">
                    ...
                    <li class="nav-item p-2 mt-1">
                        <a href="<?php echo (($this->homePath) . ($this->searchPage)); ?>">
                    ...
                    <li class="nav-item p-2 mt-1">
                        <a href="<?php echo (($this->homePath) . ($this->notifPage)); ?>">
                    ...
                    <li class="nav-item p-2 mt-1">
                        <a href="<?php echo (($this->homePath) . ($this->newPostPage)); ?>">
                    ...
                    <li class="nav-item p-2 mt-1">
                        <a href="<?php echo (($this->homePath) . ($this->profilePage)); ?>">
                    ...
                    <li class="nav-item p-2 mt-1">
                        <div class="theme-switch">
                            <input type="checkbox" role="switch" id="switch-theme" />
                            <label for="switch-theme" class="slider"></label>
